...
{
    protected static ?string $model = AboutShop::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::BuildingOffice;

    protected static ?string $recordTitleAttribute = 'AboutShop';

    protected static ?string $navigationLabel = 'About Store';

    protected static ?string $modelLabel = 'Store Information';

    protected static ?string $pluralModelLabel = 'Store Information';
