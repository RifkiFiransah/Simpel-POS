...
<head>
    ...
    <title>Invoice Purchase {{ $purchase->invoice_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="invoice">
        ...
        <div class="invoice-info">
            <div class="invoice-details">
                ...
                <div>Tanggal: {{ $purchase->created_at->format('d/m/Y H:i') }}</div>
                <div>Kasir: {{ $purchase->user->name }}</div>
                <div>Metode: {{ ucfirst($purchase->method) }}</div>
            </div>
        ...
        <div class="payment-info">
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                ...
                <span>{{ ucfirst($purchase->method) }}</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                <span><strong>Jumlah Bayar:</strong></span>
                <span>Rp {{ number_format($purchase->payment, 0, ',', '.') }}</span>
            </div>
            <div style="display: flex; justify-content: space-between; font-weight: bold;">
                <span><strong>Kembalian:</strong></span>
                <span>Rp {{ number_format($purchase->change, 0, ',', '.') }}</span>
            </div>
        </div>
