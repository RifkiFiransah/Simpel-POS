...
<body>
    ...
    <div class="summary">
        <div class="summary-row">
            ...
            <div class="summary-cell summary-header">Total Pendapatan</div>
            <div class="summary-cell summary-header">Total Item Terjual</div>
            <div class="summary-cell summary-header">Metode Pembayaran</div>
        </div>
        <div class="summary-row">
            <div class="summary-cell">{{ number_format($summary['total_transactions']) }} transaksi</div>
            <div class="summary-cell">Rp {{ number_format($summary['total_revenue'], 0, ',', '.') }}</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <span class="payment-method method-{{ $transaction->method }}">
